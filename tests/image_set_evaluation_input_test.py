...
def test_add_evaluate_image_set_success(db_session, doctor, image_set, session):
    ...
    assert evaluation.image_set_id == image_set.image_set_id
...
def test_add_evaluate_image_set_doctor_not_found(db_session, image_set, session):
...
def test_add_evaluate_image_set_session_not_found(db_session, doctor, image_set):
...
def test_add_evaluate_image_set_session_inactive(db_session, doctor, image_set):
...
def test_add_evaluate_image_set_session_mismatch(db_session, doctor, image_set):
...
def test_add_evaluate_image_set_image_set_not_found(db_session, doctor, session):
...
def test_add_evaluate_image_set_invalid_evaluation(
    db_session, doctor, image_set, session
):
...
def test_check_evaluation_exists(db_session, doctor, image_set, session):
...
def test_add_evaluate_image_set_duplicate_does_not_break_existing(
    ...
    assert check_set_evaluation_exists(
        db_session, doctor.uuid, image_set.image_set_id, session.session_id
    )
