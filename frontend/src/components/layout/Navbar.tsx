...
import { LogOut, Settings, LayoutDashboard, KeyRound, ChevronDown, User, BookOpen, PenLine, FlaskConical, ScanEye } from "lucide-react";
          ...
          <div className="relative" ref={menuRef}>
            ...
            {menuOpen && (
              <div className="absolute right-0 top-full mt-1 w-48 rounded-md border border-border bg-background shadow-lg z-50 py-1">
                ...
                {!isLabeling && <div className="my-1 border-t border-border" />}
                <button
